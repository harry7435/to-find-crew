      ...
      <section className="container mx-auto p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          <Card className="text-center w-full">
            <CardHeader>
              <CardTitle className="text-xl">내 모임</CardTitle>
              <CardDescription>만든 번개를 확인하고 새로 만들어요</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/badminton/my-sessions" className="cursor-pointer">
                <Button className="w-full">내 모임 보기</Button>
              </Link>
            </CardContent>
          </Card>
